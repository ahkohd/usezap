...
This is a spotlight-like window that typically appears at the center of your screen. It provides a convenient way to access your app library, manage apps for quick switching, and perform a range of other tasks.
![the dock](/img/screenshots/the-dock.png)
...
<DemoGif src="/img/screenshots/dock-toggle.gif" alt="access the dock"/>
...
<DemoGif src="/img/screenshots/dock-expand-collapse.gif" alt="access the dock"/>
